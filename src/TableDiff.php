...
class TableDiff
{
     ...
     *
     * @return array<string, mixed>  Keyed by table name.
     */
    ...
    /**
     * @return array<string, array{name: string, type: string, nullable: string, default: string|null, extra: string}>
     */
    ...
    /**
     * @return array<string, array{name: string, unique: bool, columns: string[]}>
     */
    ...
    /**
     * @return array<string, array{name: string, column: string, ref_db: string, ref_table: string, ref_column: string}>
     */
    ...
    {
        $signature = fn(array $fk) => "{$fk['column']}->{$fk['ref_table']}.{$fk['ref_column']}";
